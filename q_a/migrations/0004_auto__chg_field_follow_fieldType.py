...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Follow.fieldType'
        db.alter_column('q_a_follow', 'fieldType', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

    def backwards(self, orm):

        # Changing field 'Follow.fieldType'
        db.alter_column('q_a_follow', 'fieldType', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
