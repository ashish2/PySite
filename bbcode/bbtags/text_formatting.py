...
class Stri(TagNode):
    ...
    [code lang=bbdocs linenos=0][strike]Text[/strike][/code]
    """
    open_pattern = re.compile(patterns.no_argument % 's')
    close_pattern = re.compile(patterns.closing % 's')
    verbose_name = 'Strike Through'
...
class Sup(TagNode):
    ...
    [code lang=bbdocs linenos=0][strike]Text[/strike][/code]
    """
    open_pattern = re.compile(patterns.no_argument % 'sup')
    close_pattern = re.compile(patterns.closing % 'sup')
    verbose_name = 'Superscript'
    
    def parse(self):
        return '<span><sup>%s</sup></span>' % self.parse_inner()
...
class Sub(TagNode):
    ...
    [code lang=bbdocs linenos=0][strike]Text[/strike][/code]
    """
    open_pattern = re.compile(patterns.no_argument % 'sub')
    close_pattern = re.compile(patterns.closing % 'sub')
    verbose_name = 'Suberscript'
    
    def parse(self):
        return '<span><sub>%s</sub></span>' % self.parse_inner()
...
#class Ul(TagNode):
    ...
    #[code lang=bbdocs linenos=0][strike]Text[/strike][/code]
    #"""
    #open_pattern = re.compile(patterns.no_argument % 'list')
    #close_pattern = re.compile(patterns.closing % 'list')
    #verbose_name = 'Unordered List'
    #
    #def parse(self):
        #return '<ul>%s</ul>' % self.parse_inner()
    #
...
class Ol(TagNode):
    ...
    [code lang=bbdocs linenos=0][strike]Text[/strike][/code]
    """
    open_pattern = re.compile(patterns.single_argument % 'list')
    close_pattern = re.compile(patterns.closing % 'list')
    verbose_name = 'Ordered List'
    
    def parse(self):
        return '<ol>%s</ol>' % self.parse_inner()
...
class Li(TagNode):
    ...
    [code lang=bbdocs linenos=0][strike]Text[/strike][/code]
    """
    open_pattern = re.compile(patterns.no_argument % '[*]')
    close_pattern = re.compile(patterns.closing % '[/*]')
    verbose_name = 'List'
    
    def parse(self):
        return '<span><li>%s</li></span>' % self.parse_inner()
...
class Tr(TagNode):
    ...
    [code lang=bbdocs linenos=0][strike]Text[/strike][/code]
    """
    open_pattern = re.compile(patterns.no_argument % 'tr')
    close_pattern = re.compile(patterns.closing % 'tr')
    verbose_name = 'Table Row'
    
    def parse(self):
        return '<tr>%s</tr>' % self.parse_inner()
...
class Td(TagNode):
    ...
    [code lang=bbdocs linenos=0][strike]Text[/strike][/code]
    """
    open_pattern = re.compile(patterns.no_argument % 'td')
    close_pattern = re.compile(patterns.closing % 'td')
