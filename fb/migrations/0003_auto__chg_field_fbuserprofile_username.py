...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FBUserProfile.username'
        db.alter_column('fb_fbuserprofile', 'username', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'FBUserProfile.username'
        db.alter_column('fb_fbuserprofile', 'username', self.gf('django.db.models.fields.EmailField')(max_length=75))
